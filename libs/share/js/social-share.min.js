...
function() {
    ...
    function D(t, e) {
        for (var r, i, n = 1,
        o = (r = t, (i = encodeURI(r).toString().replace(/\%[0-9a-fA-F]{2}/g, "a")).length + (i.length != r ? 3 : 0)), a = 0, s = _.length; a <= s; a++) {
            var h = 0;
            switch (e) {
            case l.L:
                h = _[a][0];
...
function(r, o, h) {
    ...
    g = {
        ...
        imageSelector: h,
        weiboKey: "",
        wechatQrcodeTitle: "二维码分享",
        wechatQrcodeHelper: "<p>微信首页右上角“+”→“扫一扫”</p>",
    ...
    r.socialShare = function(t, e) { (t = "string" == typeof t ? m(t) : t).length === h && (t = [t]),
        C(t,
        function(t) {
            t.initialized ||
            function(t, e) {
                ...
                C(s ? n.reverse() : n,
                function(t) {
                    var n, o, e = (n = t, (o = a).summary || (o.summary = o.description), p[n].replace(/\{\{(\w)(\w*)\}\}/g,
                    function(t, e, r) {
                        var i = n + e + r.toLowerCase();
                        return r = (e + r).toLowerCase(),
                        encodeURIComponent((o[i] === h ? o[r] : o[i]) || "")
                    })),
                    r = a.initialized ? w(i, "icon-" + t) : _('<a class="social-share-icon icon-' + t + '" id=' + t +'shareicon></a>');
                ...
                function(t, e) {
                    ...
                    var i = _('<div class="wechat-qrcode" id="wxshare"><h4>' + e.wechatQrcodeTitle + '</h4><div class="qrcode"></div><div class="help">' + e.wechatQrcodeHelper + "</div></div>"),
                    n = w(i[0], "qrcode", "div");
                    new QRCode(n[0], {
                        text: e.url,
    ...
    function(t, e) { (e ? o: r)[a ? "attachEvent": n](a + t,
        function() {
...
$('#wxshare').html('<p>想写什么就什么，html代码也可以</p>');